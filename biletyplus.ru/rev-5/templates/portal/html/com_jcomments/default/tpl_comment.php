...
<?php if ($comment->position && $this->_globals['thisurl'] == '/reviews'){ ?><span  class="comment-date" ><?php echo $comment->position?></span> <?php } ?>
<?php
				}
?>
<span class="comment-date"><?php echo JCommentsText::formatDate($comment->date, JText::_('DATE_FORMAT')); ?></span>
