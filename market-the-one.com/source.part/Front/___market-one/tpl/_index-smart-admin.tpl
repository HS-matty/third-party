...
<html lang="en-us">
	...
	-->
	{/literal}
	<body class="smart-style-2 menu-on-top container ">
		...
		<header id="header">
			...
			<div class="pull-right">
				...
				<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
					<li class="">
						...
						<ul class="dropdown-menu pull-right">
							...
							<li class="divider"></li>
							<li>
								<a href="{$host_name}/public/smart-admin/profile.html" class="padding-10 padding-top-0 padding-bottom-0"> <i class="fa fa-user"></i> <u>P</u>rofile</a>
							</li>
							<li class="divider"></li>
							<li>
				...
				<div id="logout" class="btn-header transparent pull-right">
					<span> <a href="{$host_name}/public/smart-admin/login.html" title="Sign Out" data-action="userLogout" data-logout-msg="You can improve your security further after logging out by closing this opened browser"><i class="fa fa-sign-out"></i></a> </span>
				</div>
				<!-- end logout button -->
				...
				<ul class="header-dropdown-list hidden-xs">
					<li>
						...
						<ul class="dropdown-menu pull-right">
							...
							<li>
								<a href="javascript:void(0);"><img src="{$host_name}/public/smart-admin/img/blank.gif" class="flag flag-fr" alt="France"> Français</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="{$host_name}/public/smart-admin/img/blank.gif" class="flag flag-es" alt="Spanish"> Español</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="{$host_name}/public/smart-admin/img/blank.gif" class="flag flag-de" alt="German"> Deutsch</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="{$host_name}/public/smart-admin/img/blank.gif" class="flag flag-jp" alt="Japan"> 日本語</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="{$host_name}/public/smart-admin/img/blank.gif" class="flag flag-cn" alt="China"> 中文</a>
							</li>	
							<li>
								<a href="javascript:void(0);"><img src="{$host_name}/public/smart-admin/img/blank.gif" class="flag flag-it" alt="Italy"> Italiano</a>
							</li>	
							<li>
								<a href="javascript:void(0);"><img src="{$host_name}/public/smart-admin/img/blank.gif" class="flag flag-pt" alt="Portugal"> Portugal</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="{$host_name}/public/smart-admin/img/blank.gif" class="flag flag-ru" alt="Russia"> Русский язык</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="{$host_name}/public/smart-admin/img/blank.gif" class="flag flag-kr" alt="Korea"> 한국어</a>
							</li>						
		...
		<aside id="left-panel">
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as it --> <a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut"> <img src="{$host_name}/public/smart-admin/img/avatars/sunny.png" alt="me" class="online" /> <span> john.doe </span> <i class="fa fa-angle-down"></i> </a> </span>
			</div>
			<!-- end user info -->
