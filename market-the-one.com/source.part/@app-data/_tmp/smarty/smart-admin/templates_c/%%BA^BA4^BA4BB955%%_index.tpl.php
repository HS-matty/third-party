<?php /* Smarty version 2.6.14, created on 2017-05-06 14:39:23
         compiled from D:%5Cdev%5Cweb-server-root%5Ccms/Front/market-the-one-com/Templates/smart-admin/_index.tpl */ ?>
<!DOCTYPE html>
<html lang="en-us">
	<head>
		<meta charset="utf-8">
		...
		<!-- #CSS Links -->
		<!-- Basic Styles -->
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/css/bootstrap.min.css">
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/css/font-awesome.min.css">
		...
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/css/smartadmin-production-plugins.min.css">
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/css/smartadmin-production.min.css">
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/css/smartadmin-skins.min.css">

		<!-- SmartAdmin RTL Support -->
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/css/smartadmin-rtl.min.css"> 
		...
		<!--link rel="stylesheet" type="text/css" media="screen" href="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/css/demo.min.css"-->

		<!-- #FAVICONS -->
		<link rel="shortcut icon" href="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/img/favicon/favicon.ico" type="image/x-icon">
		<link rel="icon" href="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/img/favicon/favicon.ico" type="image/x-icon">
		...
		<link rel="apple-touch-icon" href="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/img/splash/sptouch-icon-iphone.png">
		<link rel="apple-touch-icon" sizes="76x76" href="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/img/splash/touch-icon-ipad.png">
		<link rel="apple-touch-icon" sizes="120x120" href="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/img/splash/touch-icon-iphone-retina.png">
		<link rel="apple-touch-icon" sizes="152x152" href="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/img/splash/touch-icon-ipad-retina.png">
		...
		<link rel="apple-touch-startup-image" href="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/img/splash/ipad-landscape.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:landscape)">
		<link rel="apple-touch-startup-image" href="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/img/splash/ipad-portrait.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:portrait)">
		<link rel="apple-touch-startup-image" href="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/img/splash/iphone.png" media="screen and (max-device-width: 320px)">
	...
	<body class="smart-style-2 menu-on-top fixed-ribbon fixed-page-footer container ">
		...
		<div  class="label" style="padding-left:0; padding-bottom:0;padding-right:0px;margin-top:15px"><h5 style="color:white">Market-The-One.com</h5></div>
			<div id="logo-group" >
				...
				<!--span id="logo"> <img src="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/img/logo.png" alt="Market-The-One"> </span-->
				...
				<!--div class="ajax-dropdown"-->
					...
					<!--div class="btn-group btn-group-justified" data-toggle="buttons">
						<label class="btn btn-default">
							<input type="radio" name="activity" id="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/ajax/notify/mail.html">
							Msgs (14) </label>
						<label class="btn btn-default">
							<input type="radio" name="activity" id="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/ajax/notify/notifications.html">
							notify (3) </label>
						<label class="btn btn-default">
							<input type="radio" name="activity" id="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/ajax/notify/tasks.html">
							Tasks (4) </label>
					</div-->
...
/public/smart-admin/img/avatars/sunny.png" alt="John Doe" class="online"-->  
							<div style="padding-top:12px;padding-left:10px"><i class="fa fa-user"></i> <?php echo $this->_tpl_vars['user']->email; ?>
...
/App/User/Profile/View" class="padding-10 padding-top-0 padding-bottom-0"> <i class="fa fa-user"></i> <u>P</u>rofile</a>
							</li>
								<li class="divider"></li>
							<li>
								<a href="<?php echo $this->_tpl_vars['host_name']; ?>
/App/User/Settings/View" class="padding-10 padding-top-0 padding-bottom-0"><i class="fa fa-cog"></i> <u>S</u>ettings</a>
							</li>
							...
							<li>
								<a href="<?php echo $this->_tpl_vars['host_name']; ?>
/logout" class="padding-10 padding-top-5 padding-bottom-5" data-action="userLogout"><i class="fa fa-sign-out fa-lg"></i> <strong><u>L</u>ogout</strong></a>
							</li>
						</ul>
					</li>
				</ul>
				...
				<div id="logout" class="btn-header transparent pull-right">
					<span> <a href="<?php echo $this->_tpl_vars['host_name']; ?>
/" title="Sign Out" data-action="userLogout" data-logout-msg=""><i class="fa fa-sign-out"></i></a> test</span>
				</div>
				<!-- end logout button -->
				...
				<!-- input: search field -->
				<!--form action="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/search.html" class="header-search pull-right">
				...
				<!--ul class="header-dropdown-list hidden-xs">
					<li>
						...
						<ul class="dropdown-menu pull-right">
							<li class="active">
								<a href="javascript:void(0);"><img src="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/img/blank.gif" class="flag flag-us" alt="United States"> English (US)</a>
							</li>
					
							<li>
								<a href="javascript:void(0);"><img src="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/img/blank.gif" class="flag flag-ru" alt="Russia"> Русский язык</a>
							</li>
		...
		<aside id="left-panel">
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as it --> <a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut"> <img src="<?php echo $this->_tpl_vars['host_name']; ?>
/public/smart-admin/img/avatars/sunny.png" alt="me" class="online" /> <span> <?php echo $this->_tpl_vars['user_name']; ?>
: <?php echo $this->_tpl_vars['user']->email; ?>
 </span> <i class="fa fa-angle-down"></i> </a> </span>
			</div>
			<!-- end user info -->
...
/" title="<?php echo $this->_tpl_vars['menu_item']->title; ?>
"><?php echo $this->_tpl_vars['menu_item']->name; ?>
				...
				<?php endif; ?>
						...
						<li style="width:120px;height:50px"><div style="padding-top:33px;padding-left:30px;width:100px"><strong><?php echo $this->_tpl_vars['current_menu_element']->getTitle(); ?>
:</strong></div></li>
...
?>
					...
					<li  <?php if (! $this->_tpl_vars['current_menu_element']->sub_menu_not_active && $this->_tpl_vars['sub_menu_item']->name == $this->_tpl_vars['current_sub_menu_element']->name): ?> class="active" <?php endif; ?>>
...
/"> 
							<?php endif; ?>
								<span class="menu-item-parent" style="padding-top:15px;font-size:13px"> <?php echo $this->_tpl_vars['sub_menu_item']->title; ?>
</span>
							</a>
							
							<?php if ($this->_tpl_vars['sub_menu_item']->hasElements()): ?>
							<?php $this->assign('current_sub_menu_item_dropdown', $this->_tpl_vars['sub_menu_item']->getCurrentElement()); ?>
...
?>
								<li <?php if ($this->_tpl_vars['current_sub_menu_item_dropdown']->name == $this->_tpl_vars['sub_menu_item_dropdown']->name): ?> class="active"<?php endif; ?>>
									<a href="<?php echo $this->_tpl_vars['host_name']; ?>
/<?php echo $this->_tpl_vars['sub_menu_item_dropdown']->getAppPath(); ?>
"><?php echo $this->_tpl_vars['sub_menu_item_dropdown']->getTitle(); ?>
</a>
								</li>
