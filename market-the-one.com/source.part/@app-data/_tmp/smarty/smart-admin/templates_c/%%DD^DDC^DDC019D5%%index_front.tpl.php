<?php /* Smarty version 2.6.14, created on 2017-05-06 14:39:26
         compiled from D:%5Cdev%5Cweb-server-root%5Ccms/Front/market-the-one-com/Templates/smart-admin/index_front.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    ...
    <div class="container">
     ...
     <div class="hero-unit">
		<h2>Market-The-One.com!</h2>
			...
			<br>
	<ul>
	 <?php if ($this->_tpl_vars['user']->type == 'user_backend'): ?>
