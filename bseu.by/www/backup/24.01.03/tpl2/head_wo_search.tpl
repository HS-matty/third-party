...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="up_menu" bgcolor="#E5E5E5">
  <tr> 
    ...
    <td width="15%"> 
      <div align="center"><a href="catalog.php">Catalog</a></div>
    </td>
    <td width="15%"> 
      <div align="center"><a href="new_cd.php">New CD-DISCs</a></div>
    </td>
    <td width="*">&nbsp;</td>
    <td width="15%"> 
  ...
  <form name="search_form" method="post" action="search.php">
    <tr bgcolor="#ACD959"> 
      <td colspan="3" align="left" valign="middle" bgcolor="#ACD959" class="text1">  &nbsp;
      </td>
      <td width="*">&nbsp;</td>
      <td colspan="2">
