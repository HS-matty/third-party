<?php /* Smarty version 2.6.14, created on 2014-05-18 12:50:34
...
?>
				<tr data-id="<?php echo $this->_tpl_vars['row']['service_id']; ?>
">
					...
					<td>
						<a class="btn btn-success btn-xs pay" title="Перейти к оплате" data-amount="<?php echo $this->_tpl_vars['row']['balance']; ?>
"><span class="glyphicon glyphicon-ok"></span> Оплатить</a>
