<?php
/* $Id: hebrew.inc.php,v 1.1 2002/02/18 13:43:26 lem9 Exp $ */
...
$strAccessDenied = 'הגישה נדחית';
$strAction = 'פעולה';
$strAddDeleteColumn = 'הוסף/מחק שורות שדה';
$strAddDeleteRow = 'הוסף/מחק שורת קריטריון';
$strAddNewField = 'הוסף שדה חדש';
$strAddPriv = 'הוסף זכות(פריבילגיה) חדשה';
$strAddPrivMessage = 'הוספת זכות(פריבלגיה) חדשה.';
...
$strDoAQuery = 'עשה "שאילתה לדוגמה" (תו כללי: "%")';
$strDocu = 'תיעוד';
$strDoYouReally = 'אתה באמת רוצה ';
$strDrop = 'הסר';
$strDropDB = 'הסר מסד נתונים ';
...
$strNoQuery = 'אין שאילתת SQL!';  //to translate
...
$strPasswordNotSame = 'הסיסמאות אינן אותו הדבר!';
...
$strRevokeGrantMessage = 'אתה פסלת את הרשאת ה- Grant מ- %s';
$strRevokeMessage = 'אתה פסלת את ההרשמה מ- %s';
...
$strRowsModeOptions = 'במצב %s חזור על הכותרת על העליונה לאחר %s cells';
...
$strTableHasBeenFlushed = 'Table %s נשטפה';
...
$strViewDumpDB = 'הראה את סכמת מד הנתונים';

$strWelcome = 'ברוך הבא ל- %s';
$strWithChecked = 'עם נבחר:';
$strWrongUser = 'שם משתמש/סיסמה שגויים. הגישה נדחית.';
