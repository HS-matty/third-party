<?php
/* $Id: config.inc.php,v 1.71 2002/02/13 20:34:12 lem9 Exp $ */
 ...
 */
$cfgPmaAbsoluteUri = 'http://www.kay.by/php_admin/';
...
$cfgServers[1]['host']          = 'glade.tut.by'; // MySQL hostname
...
$cfgServers[1]['user']          = 'kayby';      // MySQL user
$cfgServers[1]['password']      = 'owGOrers97';          // MySQL password (only needed with 'config' auth)
$cfgServers[1]['only_db']       = 'kayby';          // If set to a db-name, only this db is displayed at left frame
