<?php
/* $Id: user_details.php,v 1.52 2002/02/10 09:24:47 loic1 Exp $*/
...
<ul>
    ...
    <li>
        ...
        <a href="user_details.php?lang=<?php echo $lang; ?>&amp;server=<?php echo $server; ?>&amp;db=mysql&amp;table=user&amp;mode=reload">
...
<ul>
    ...
    <li>
        <div style="margin-bottom: 10px">
        <a href="user_details.php?lang=<?php echo $lang; ?>&amp;server=<?php echo $server; ?>&amp;db=mysql&amp;table=user">
