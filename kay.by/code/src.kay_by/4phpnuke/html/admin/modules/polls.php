...
function poll_createPoll() {
    global $language, $hlpfile, $admin, $multilingual;
    include ('header.php');
...
function poll_createPosted($pollTitle, $optionText, $planguage, $title, $hometext, $topic, $bodytext, $catid, $ihome, $acomm) {
	...
	$result = sql_query("insert into $prefix"._stories." values (NULL, '$catid', '$aid', '$title', now(), '$hometext', '$bodytext', '0', '0', '$topic', '$aid', '', '$ihome', '$planguage', '$acomm', '0', '0')", $dbi);
    }
    Header("Location: admin.php?op=adminMain");
}
...
function savepoll($pollID, $pollTitle, $optiontext1, $optiontext2, $optiontext3, $optiontext4, $optiontext5, $optiontext6, $optiontext7, $optiontext8, $optiontext9, $optiontext10, $optiontext11, $optiontext12) {
    global $prefix, $dbi;
    $result = sql_query("update $prefix"._poll_desc." set pollTitle='$pollTitle' where pollID='$pollID'", $dbi);
