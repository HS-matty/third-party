...
function displayadmins() {
    global $hlpfile, $admin, $prefix, $dbi, $language, $multilingual;
    include("header.php");
...
function modifyadmin($chng_aid) {
    global $hlpfile, $aid, $prefix, $dbi, $multilingual;
    include("header.php");
    GraphicAdmin($hlpfile);
    OpenTable();
    echo "<center><font class=\"title\"><b>"._AUTHORSADMIN."</b></font></center>";
    ...
    $result = sql_query("select aid, name, url, email, pwd, radminarticle,radmintopic,radminuser,radminsurvey,radminsection,radminlink,radminephem,radminfilem,radminfaq,radmindownload,radminreviews,radminnewsletter,radminsuper,admlanguage from $prefix"._authors." where aid='$chng_aid'", $dbi);
    list($chng_aid, $chng_name, $chng_url, $chng_email, $chng_pwd, $chng_radminarticle, $chng_radmintopic, $chng_radminuser, $chng_radminsurvey, $chng_radminsection, $chng_radminlink, $chng_radminephem, $chng_radminfilem, $chng_radminfaq, $chng_radmindownload, $chng_radminreviews, $chng_radminnewsletter, $chng_radminsuper, $chng_admlanguage) = sql_fetch_row($result, $dbi);
    $aid = $chng_aid;
	...
	."<td><input type=\"checkbox\" name=\"chng_radminreviews\" value=\"1\" $sel11> "._REVIEWS."</td>"
	."<td><input type=\"checkbox\" name=\"chng_radminnewsletter\" value=\"1\" $sel12> "._NEWSLETTER."</td>"
	."</tr><tr><td>&nbsp;</td>"
...
function updateadmin($chng_aid, $chng_name, $chng_email, $chng_url, $chng_radminarticle, $chng_radmintopic, $chng_radminuser, $chng_radminsurvey, $chng_radminsection, $chng_radminlink, $chng_radminephem, $chng_radminfilem, $chng_radminfaq, $chng_radmindownload, $chng_radminreviews, $chng_radminnewsletter, $chng_radminsuper, $chng_pwd, $chng_pwd2, $chng_admlanguage, $aid) {
    global $prefix, $dbi;
	...
	if ($chng_radminsuper == 1) {
	    $result = sql_query("update $prefix"._authors." set aid='$chng_aid', email='$chng_email', url='$chng_url', radminarticle='0', radmintopic='0', radminuser='0', radminsurvey='0', radminsection='0', radminlink='0', radminephem='0', radminfilem='0', radminfaq='0', radmindownload='0', radminreviews='0', radminnewsletter='0', radminsuper='$chng_radminsuper', pwd='$chng_pwd', admlanguage='$chng_admlanguage' where name='$chng_name'", $dbi);
	    Header("Location: admin.php?op=mod_authors");
	} else {
	    $result = sql_query("update $prefix"._authors." set aid='$chng_aid', email='$chng_email', url='$chng_url', radminarticle='$chng_radminarticle', radmintopic='$chng_radmintopic', radminuser='$chng_radminuser', radminsurvey='$chng_radminsurvey', radminsection='$chng_radminsection', radminlink='$chng_radminlink', radminephem='$chng_radminephem', radminfilem='$chng_radminfilem', radminfaq='$chng_radminfaq', radmindownload='$chng_radmindownload', radminreviews='$chng_radminreviews', radminnewsletter='$chng_radminnewsletter', radminsuper='0', pwd='$chng_pwd', admlanguage='$chng_admlanguage' where name='$chng_name'", $dbi);
	    Header("Location: admin.php?op=mod_authors");
	}
    } else {
	if ($chng_radminsuper == 1) {
	    $result = sql_query("update $prefix"._authors." set aid='$chng_aid', email='$chng_email', url='$chng_url', radminarticle='0', radmintopic='0', radminuser='0', radminsurvey='0', radminsection='0', radminlink='0', radminephem='0', radminfilem='0', radminfaq='0', radmindownload='0', radminreviews='0', radminnewsletter='0', radminsuper='$chng_radminsuper', admlanguage='$chng_admlanguage' where name='$chng_name'", $dbi);
	    Header("Location: admin.php?op=mod_authors");
	} else {
    ...
    if ($aid != $chng_aid) {
	$result = sql_query("select sid, informant from $prefix"._stories." where aid='$aid'", $dbi);
	while(list($sid, $informant) = sql_fetch_row($result)) {
	    sql_query("update $prefix"._stories." set aid='$chng_aid' where aid='$aid' AND sid='$sid'", $dbi);
	    if ($aid == $informant) {
