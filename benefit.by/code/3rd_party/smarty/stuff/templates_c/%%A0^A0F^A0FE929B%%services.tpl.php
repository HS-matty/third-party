<?php /* Smarty version 2.6.14, created on 2008-01-30 15:44:37
         compiled from Z:%5Chome%5Cbenefitby%5Cwww/application/views/admin/services.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'Z:\\home\\benefitby\\www/application/views/admin/services.tpl', 10, false),)), $this); ?>
﻿
...
?>
					<option <?php if ($this->_tpl_vars['u']['bluser_id'] == $this->_tpl_vars['Params']['user_id']): ?> selected <?php endif; ?> value="<?php echo $this->_tpl_vars['u']['bluser_id']; ?>
"><?php echo $this->_tpl_vars['u']['company']; ?>
</option>
...
?>
					<option <?php if ($this->_tpl_vars['s']['category_id'] == $this->_tpl_vars['Params']['service']): ?> selected <?php endif; ?> value="<?php echo $this->_tpl_vars['s']['category_id']; ?>
