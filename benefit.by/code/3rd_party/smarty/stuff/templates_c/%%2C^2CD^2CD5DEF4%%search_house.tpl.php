<?php /* Smarty version 2.6.14, created on 2007-10-30 19:07:58
         compiled from z:/home/barefoot_zend/www/application/views/frontend/directory/search_house.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'z:/home/barefoot_zend/www/application/views/frontend/directory/search_house.tpl', 51, false),array('modifier', 'money_format', 'z:/home/barefoot_zend/www/application/views/frontend/directory/search_house.tpl', 134, false),)), $this); ?>
...
<?php endforeach; endif; unset($_from); ?>
										...
										<td width="60">Bedrooms:</td>
										<td width="100">

											<select name="bedrooms">
								<option value="">Any</option>
<option <?php if ($this->_tpl_vars['GET']['bedrooms'] == 1): ?> selected <?php endif; ?>value="1">1+</option>
<option <?php if ($this->_tpl_vars['GET']['bedrooms'] == 2): ?> selected <?php endif; ?>value="2">2+</option>
<option <?php if ($this->_tpl_vars['GET']['bedrooms'] == 3): ?> selected <?php endif; ?> value="3">3+</option>
<option <?php if ($this->_tpl_vars['GET']['bedrooms'] == 4): ?> selected <?php endif; ?>value="4">4+</option>
<option <?php if ($this->_tpl_vars['GET']['bedrooms'] == 5): ?> selected <?php endif; ?>value="5">5+</option>
<option <?php if ($this->_tpl_vars['GET']['bedrooms'] == 6): ?> selected <?php endif; ?>value="6">6+</option>
<option <?php if ($this->_tpl_vars['GET']['bedrooms'] == 7): ?> selected <?php endif; ?>value="7">7+</option>
<option <?php if ($this->_tpl_vars['GET']['bedrooms'] == 8): ?> selected <?php endif; ?>value="8">8+</option>
</select>
										</td>
										<td width="75">Zip Code(s):</td>
										<td><input type="text" name="zip"  value="<?php echo ((is_array($_tmp=$this->_tpl_vars['GET']['zip'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"></td>
									</tr>
									<tr>
										<td>Keywords:</td>
...
"></td>
	...
	<option value="">Any</option>
<option <?php if ($this->_tpl_vars['GET']['bathrooms'] == 1): ?> selected <?php endif; ?>value="1">1+</option>
<option <?php if ($this->_tpl_vars['GET']['bathrooms'] == 2): ?> selected <?php endif; ?>value="2">2+</option>
<option <?php if ($this->_tpl_vars['GET']['bathrooms'] == 3): ?> selected <?php endif; ?> value="3">3+</option>
<option <?php if ($this->_tpl_vars['GET']['bathrooms'] == 4): ?> selected <?php endif; ?>value="4">4+</option>
<option <?php if ($this->_tpl_vars['GET']['bathrooms'] == 5): ?> selected <?php endif; ?>value="5">5+</option>
<option <?php if ($this->_tpl_vars['GET']['bathrooms'] == 6): ?> selected <?php endif; ?>value="6">6+</option>
<option <?php if ($this->_tpl_vars['GET']['bathrooms'] == 7): ?> selected <?php endif; ?>value="7">7+</option>
<option <?php if ($this->_tpl_vars['GET']['bathrooms'] == 8): ?> selected <?php endif; ?>value="8">8+</option>

</select>
										</td>
										<td>Max Price:</td>
										<td width="100"><input type="text" name="price" value="<?php echo $this->_tpl_vars['GET']['price']; ?>
"></td>
								...
								<td width="732" valign="top" id="resultSet">
									<div class="pagination">
										<table width="100%" cellpadding="0" cellspacing="0">
											<tr>
												<td align="left">
													<?php if (! $this->_tpl_vars['qr']->getTotalRows()): ?> No listings were found. Please search again. </td><?php else: ?>		
												<?php echo $this->_tpl_vars['qr']->getCurrentPageRowsIndexStart(); ?>
...
?>
	<tr>	<td valign='top' align='center' width="25" height="33" ><img src="<?php echo $this->_tpl_vars['StartLink']; ?>
...
, <?php echo $this->_tpl_vars['l']['state']; ?>
												...
												<td align="right" valign="top" nowrap="nowrap">
													...
													<?php echo $this->_tpl_vars['l']['bedrooms']; ?>
BR <?php echo $this->_tpl_vars['l']['bathrooms']; ?>
BA<br />
													<a href="<?php echo $this->_tpl_vars['HostName']; ?>
/directory/item/?item_id=<?php echo $this->_tpl_vars['l']['listing_id']; ?>
" class="smallLink">Full Listing</a>
													| <a href="javascript:;" onclick="showSaveBubble(this,<?php echo $this->_tpl_vars['l']['listing_id']; ?>
