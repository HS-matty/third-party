<?php /* Smarty version 2.6.14, created on 2008-01-30 16:12:11
         compiled from Z:%5Chome%5Cbenefitby%5Cwww/application/views/_index/string_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'Z:\\home\\benefitby\\www/application/views/_index/string_edit.tpl', 21, false),)), $this); ?>
...
<td>
<?php echo $this->_tpl_vars['f']->ViewObject->Create(); ?>
</td></tr>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['f']->getValue(1))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</textarea>
			<?php else: ?>
			<input name="<?php echo $this->_tpl_vars['f']->ID; ?>
