<?php /* Smarty version 2.6.14, created on 2007-11-06 13:50:29
         compiled from z:/home/barefoot_zend/www/application/views/frontend/directory/search_job.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'z:/home/barefoot_zend/www/application/views/frontend/directory/search_job.tpl', 48, false),array('modifier', 'money_format', 'z:/home/barefoot_zend/www/application/views/frontend/directory/search_job.tpl', 116, false),)), $this); ?>
<div id="searchForm">
...
<?php endforeach; endif; unset($_from); ?>
										...
										<td width="100">
<select name="position_type" style="width:100px;" >
					<option value="" >none</option>
					<option value="intern" <?php if ($this->_tpl_vars['GET']['position_type'] == 'intern'): ?>  selected <?php endif; ?>>intern</option>
					<option value="part-time" <?php if ($this->_tpl_vars['GET']['position_type'] == 'part-time'): ?>  selected <?php endif; ?>>part-time</option>
					<option value="full-time" <?php if ($this->_tpl_vars['GET']['position_type'] == 'full-time'): ?>  selected <?php endif; ?> >full-time</option>
					<option value="contract" <?php if ($this->_tpl_vars['GET']['position_type'] == 'contract'): ?>  selected <?php endif; ?> >contract</option>
...
"></td>
										<td>Zip Code(s):</td>
										<td>
<input type="text" name="zip"  value="<?php echo ((is_array($_tmp=$this->_tpl_vars['GET']['zip'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">
										</td>
										<td></td>
										<td width="100"></td>
...
, <?php echo $this->_tpl_vars['l']['state']; ?>
												...
												<td align="right" valign="top" nowrap="nowrap">
													<strong><?php echo ((is_array($_tmp=$this->_tpl_vars['l']['compensation'])) ? $this->_run_mod_handler('money_format', true, $_tmp, "%i") : smarty_modifier_money_format($_tmp, "%i")); ?>
</strong><br />
