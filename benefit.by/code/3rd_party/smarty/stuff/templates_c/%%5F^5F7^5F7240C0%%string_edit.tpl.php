<?php /* Smarty version 2.6.14, created on 2008-03-02 13:42:38
         compiled from Z:%5Chome%5Cbenefitby%5Cwww/application/views/_index/calculator/string_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'Z:\\home\\benefitby\\www/application/views/_index/calculator/string_edit.tpl', 20, false),)), $this); ?>
...
<?php else: ?>
<tr>
<td align="left"><div class="search_text"><?php echo $this->_tpl_vars['f']->Title;  if ($this->_tpl_vars['f']->isRequired): ?><font color="red">*</font><?php endif; ?>:</div>
...
"><?php echo $this->_tpl_vars['f']->getValue(1); ?>
			...
			<?php else: ?>
			<input name="<?php echo $this->_tpl_vars['f']->ID; ?>
"  id="sum" <?php if ($this->_tpl_vars['f']->View->Type == 'password'): ?> type="password" <?php else: ?> type="text"  value="<?php echo $this->_tpl_vars['f']->getValue(); ?>
" <?php endif; ?>>
			<?php endif; ?>
		<?php endif; ?>
