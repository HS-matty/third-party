<?php /* Smarty version 2.6.14, created on 2008-02-21 13:41:38
         compiled from Z:%5Chome%5Cbenefitby%5Cwww/application/views/_index/calculator/int_edit.tpl */ ?>
...
<tr>
<td align="right"><?php echo $this->_tpl_vars['f']->Title;  if ($this->_tpl_vars['f']->isRequired): ?><font color="red">*</font><?php endif; ?>:</td>
<td>
...
<?php else: ?>
<tr>
<td align="left"><?php echo $this->_tpl_vars['f']->Title;  if ($this->_tpl_vars['f']->isRequired): ?><font color="red">*</font><?php endif; ?>:<br>
<input id="sum" name="<?php echo $this->_tpl_vars['f']->ID; ?>
...
">
    ...
    foreach ($_from as $this->_tpl_vars['e']):
?>
								<span class="error_message"><?php echo $this->_tpl_vars['e']; ?>
</span>
							<?php endforeach; endif; unset($_from); ?>
	<?php endif; ?></td>
</tr>
