...
{if $success}
	<h3>New password sent to your email</h3>
{else}
...
<form method="POST" enctype="multipart/form-data"  id="add_form">
					...
					<!-- InstanceBeginEditable name="content" -->
						<div id="postPage">
							...
							If you have forgotten your password, please enter your email address below and we will email you a new, randomly generated password.
							<br /><br />
